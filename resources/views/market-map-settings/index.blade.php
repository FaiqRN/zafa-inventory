...
@section('page_title', 'Pengaturan Market Map')

@section('breadcrumb')
<li class="breadcrumb-item"><a href="{{ url('/') }}">Home</a></li>
<li class="breadcrumb-item"><a href="{{ route('user.index') }}">Sistem Pengaturan</a></li>
<li class="breadcrumb-item active">Pengaturan Market Map</li>
@endsection
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="alert alert-info">
                ...
                <strong>Informasi:</strong> Pengaturan ini mengontrol perhitungan dan analisis Market Map CRM. 
...
function saveSettings() {
    ...
    $.ajax({
        url: '{{ route("market-map-settings.update") }}',
        type: 'POST',
        data: {
...
function resetSettings() {
    $.ajax({
        url: '{{ route("market-map-settings.reset") }}',
        type: 'POST',
        data: {
            _token: $('meta[name="csrf-token"]').attr('content')
        },
...
function getCategoryLabel($category) {
    $labels = [
        'clustering' => 'Pengaturan Clustering',
        'profit' => 'Pengaturan Profit & Margin',
        'stock' => 'Pengaturan Stok',
