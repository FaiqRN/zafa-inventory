...
@section('page_title', 'Pengaturan Partner Performance')

@section('breadcrumb')
<li class="breadcrumb-item"><a href="{{ url('/') }}">Home</a></li>
<li class="breadcrumb-item"><a href="{{ route('user.index') }}">Sistem Pengaturan</a></li>
<li class="breadcrumb-item active">Pengaturan Partner Performance</li>
@endsection
    ...
    <div class="card">
        <div class="card-header bg-primary">
            <h3 class="card-title text-white">
                ...
                Pengaturan Partner Performance Analytics
            </h3>
        ...
        <div class="card-body">
            <div class="alert alert-info">
                ...
                <strong>Informasi:</strong> Pengaturan ini mengontrol perhitungan grading dan performance score partner.
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        required
                                    >
                                    @elseif($setting->type == 'number' || $setting->type == 'percentage')
                                    <input
                                        type="number"
                                        class="form-control setting-input"
                                        id="setting_{{ $setting->key }}"
...
function saveSettings() {
    ...
    $.ajax({
        url: '{{ route("partner-performance-settings.update") }}',
        type: 'POST',
        data: {
...
function resetSettings() {
    $.ajax({
        url: '{{ route("partner-performance-settings.reset") }}',
        type: 'POST',
        data: {
            _token: $('meta[name="csrf-token"]').attr('content')
        },
...
function getCategoryLabel($category) {
    $labels = [
        'grading' => 'Pengaturan Grading System',
        'weights' => 'Pengaturan Bobot (Weights)',
        'performance' => 'Pengaturan Performance Threshold',
        'calculation' => 'Pengaturan Perhitungan',
