...
<!-- Splash Screen -->
<div id="splash-screen" class="welcome" data-has-errors="{{ $showSplashError ? '1' : '0' }}" data-error-message="{{ $showSplashError ? ($errors->first('username') ?? $errors->first('password') ?? 'Username atau password tidak valid') : '' }}">
  <!-- Welcome Content -->
