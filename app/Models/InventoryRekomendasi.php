...
class InventoryRekomendasi extends Model
{
    ...
    // ── Kolom relasi (tetap disimpan untuk kemudahan query di service) ───────
    ...
    /**
     * PK bukan autoincrement — nilainya string dari barang_toko.barang_toko_id
     */
    ...
    {
        return $this->belongsTo(BarangToko::class, self::FIELD_BARANG_TOKO_ID, 'barang_toko_id');
    }
